...
class LoggerProxy {
  constructor(logger, options) {
    this.logger = logger;
    this.childrens = {}; //container for created loggers by this.get()
    this.options = {
      ...options
    }
  }
  ...
  get(loggerName, options) {
    return this.childrens[loggerName] ||
      (this.childrens[loggerName] = new LoggerProxy(this, {...this.options, ...options, loggerName}));
  }
}
